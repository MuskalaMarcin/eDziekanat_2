    ...
    <div id="menu">
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item"><a class="pure-menu-link" href="adminreservations">Oczekujące rezerwacje</a>
                </li>
                <li class="pure-menu-item  pure-menu-selected">
                    <form action="adminreservations" method="post">
                        <input type="hidden" name="action" value="history">
                        <button class="linkButton" type="submit"><font color="white">Historia rezerwacji</font></button>
                    </form>
                </li>
                <li class="pure-menu-item"><a
                        class="pure-menu-link" href="adminaddclassroom">Dodaj salę</a></li>
    ...
    <div id="main">
        ...
        <div class="content">
            <h2 class="content-subhead">
                Historia rezerwacji sal
            </h2>
            <br>
            <c:choose>
                <c:when test="${empty reservationsList}">
                    <center>
                        Brak rozpatrzonych wcześniej rezerwacji.
                    </center>
                </c:when>
                <c:otherwise>
